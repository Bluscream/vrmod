	...
	"localization" : [
		{
			...
			"/actions/main/in/boolean_spawnmenu" : "Spawn Menu / Context Menu",
...
local cv_bindingVersion = CreateClientConVar("vrutil_bindingversion", "0", true, false)
if cv_bindingVersion:GetInt() < 10 then
	cv_bindingVersion:SetInt(10)
